...
if __name__=='__main__':
    ...
    path_l = '/home/baudinpy/svmdata/segmentation_out/learning/'
    C = [0.1]
    Cp = [1e0, 1e2, 1e6]    
    methods_lLnC1e_1 = [
        {'name':'lLnCp{}C{}'.format(cp,c), 
         'path':path_l+'2013.01.21.exp_latent_DDACI_crop2_Lnone_x1000_Cp{}_C{}/**/*'.format(cp,c), 
         'x':'{:.0e}'.format(cp)}\
        for c in C for cp in  Cp]
    #methods_lLnC1e0 = [
    #    {'name':'lLnCp{}C{}'.format(cp,c), 
    #     'path':path_l+'2013.01.21.exp_latent_DDACI_crop2_Lnone_x1000_Cp{}_C{}/**/*'.format(cp,c), 
    #     'x':'{:.0e}'.format(cp)}\
    ...
    methods_bLnC1e_1 = [
        {'name':'bLn{}C{}'.format(cp,c), 
         'path':path_l+'2013.01.21.exp_baseline_crop2_Lnone_x1000_Cp{}_C{}/**/*'.format(cp,c), 
         'x':'{:.0e}'.format(cp)}\
        for c in C for cp in  Cp]
    #methods_bLnC1e0 = [
    #    {'name':'bLn{}C{}'.format(cp,c), 
    ...
    method_enty1e0 = {
        ...
        'path':'/home/baudinpy/svmdata/segmentation_out/segmentation/2013.01.27.segmentation/entropy1e0/f09*', 
        'x':'',
        }
    ...
    series1 = [
        ...
        {'name':'handtuned2', 'title': 'Hand-tuned', 'methods':[method_enty1e0]*len(methods_lLnC1e_1)},
        ]
    # series2 = [
    ...
    fig = plot_utils.plot_loss(series1, ratio=0.5)
